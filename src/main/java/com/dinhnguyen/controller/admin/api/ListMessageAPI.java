...
public class ListMessageAPI extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		Message tinnhan = httpUtil.of(req.getReader()).toUsers(Message.class);
		List<Message> listmes = messageService.findAllbyid(tinnhan.getId_nguoigui(), tinnhan.getId_nguoinhan(),tinnhan.getId_nhomchat());
